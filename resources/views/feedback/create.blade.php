            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <div class="alert alert-info">
                        <h6><i class="fas fa-info-circle me-2"></i>Séance : {{ $session->title }}</h6>
                        <p class="mb-1"><strong>Date :</strong> {{ $session->scheduled_at->format('d/m/Y H:i') }}</p>
                        <p class="mb-1"><strong>Matière :</strong> {{ ucfirst($session->subject) }}</p>
                        <p class="mb-0"><strong>Vous notez :</strong> {{ $reviewedUser->name }}</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('feedback.store', $session) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="rating-stars mb-2">
                                @for ($i = 1; $i <= 5; $i++)
                                    <input type="radio" name="rating" value="{{ $i }}" id="star{{ $i }}" class="rating-input" {{ old('rating') == $i ? 'checked' : '' }}>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-paper-plane me-2"></i>Envoyer ma notation
                            </button>
                        </div>
                    </form>
                </div>
